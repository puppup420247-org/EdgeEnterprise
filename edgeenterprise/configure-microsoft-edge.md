...
Go to the [Microsoft Edge Enterprise landing page](https://aka.ms/EdgeEnterprise) to download the Microsoft Edge policy templates file (*MicrosoftEdgePolicyTemplates*).
...
1. On the target computer, open the *MicrosoftEdgePolicyTemplates* file and go to **windows** > **admx**.
