...
When configured correctly, navigation to a neutral site will stay where it started - either Microsoft Edge or IE mode. Additionally, configuring neutral sites ensures that modern applications using the same authentication servers are not impacted. 
